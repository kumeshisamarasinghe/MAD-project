...
public class bmiactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        magedisplay.setText(intent.getStringExtra("age"));
        mheightdisplay.setText(intent.getStringExtra("height"));
        mweightdisplay.setText(intent.getStringExtra("weight"));
        ...
        mgotomain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1=new Intent(getApplicationContext(), com.example.homepage.BmiMainActivity.class);
